 ...
 * @author Shai Almog
 */
public class FileChooserDemoStub implements Runnable, WindowListener {
    private static final String APP_TITLE = "Hi World";
    private static final String APP_NAME = "FileChooserDemo";
    ...
    private FileChooserDemo mainApp;
    ...
    public static void main(String[] args) {
        ...
        SwingUtilities.invokeLater(new FileChooserDemoStub());
    }
